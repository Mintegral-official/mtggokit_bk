...
package io_metricslog_client // import "github.com/Mintegral-official/mtggokit/metrics/metricslog/client_model/go"
...
type MetricFamily struct {
    ...
    Type                 *MetricType `protobuf:"varint,3,opt,name=type,enum=io.metricslog.client.MetricType" json:"type,omitempty"`
...
func init() {
    proto.RegisterType((*LabelPair)(nil), "io.metricslog.client.LabelPair")
    proto.RegisterType((*Gauge)(nil), "io.metricslog.client.Gauge")
    proto.RegisterType((*Counter)(nil), "io.metricslog.client.Counter")
    proto.RegisterType((*Quantile)(nil), "io.metricslog.client.Quantile")
    proto.RegisterType((*Summary)(nil), "io.metricslog.client.Summary")
    proto.RegisterType((*Untyped)(nil), "io.metricslog.client.Untyped")
    proto.RegisterType((*Histogram)(nil), "io.metricslog.client.Histogram")
    proto.RegisterType((*Bucket)(nil), "io.metricslog.client.Bucket")
    proto.RegisterType((*Metric)(nil), "io.metricslog.client.Metric")
    proto.RegisterType((*MetricFamily)(nil), "io.metricslog.client.MetricFamily")
    proto.RegisterEnum("io.metricslog.client.MetricType", MetricType_name, MetricType_value)
}
