...
package io_elasticsearch_client // import "github.com/Mintegral-official/mtggokit/metrics/elasticsearch/client_model/go"
...
type MetricFamily struct {
    ...
    Type                 *MetricType `protobuf:"varint,3,opt,name=type,enum=io.elasticsearch.client.MetricType" json:"type,omitempty"`
...
func init() {
    proto.RegisterType((*LabelPair)(nil), "io.elasticsearch.client.LabelPair")
    proto.RegisterType((*Gauge)(nil), "io.elasticsearch.client.Gauge")
    proto.RegisterType((*Counter)(nil), "io.elasticsearch.client.Counter")
    proto.RegisterType((*Quantile)(nil), "io.elasticsearch.client.Quantile")
    proto.RegisterType((*Summary)(nil), "io.elasticsearch.client.Summary")
    proto.RegisterType((*Untyped)(nil), "io.elasticsearch.client.Untyped")
    proto.RegisterType((*Histogram)(nil), "io.elasticsearch.client.Histogram")
    proto.RegisterType((*Bucket)(nil), "io.elasticsearch.client.Bucket")
    proto.RegisterType((*Metric)(nil), "io.elasticsearch.client.Metric")
    proto.RegisterType((*MetricFamily)(nil), "io.elasticsearch.client.MetricFamily")
    proto.RegisterEnum("io.elasticsearch.client.MetricType", MetricType_name, MetricType_value)
}
